...
%buat variabel hasil yang dimensinya = citra input
hasil = negatif;
%buat matrix yang ukurannya = citra input 
[m,n] = size(negatif);
%lakukan perulangan pada proses perhitungan 
for x = 1:m
    for y = 1:n
        hasil(x,y) = 255 - negatif(x,y);
    end
end     
%tentukan tempat citra ditampilkan
axes(handles.axes2);
%tampilkan hasil
imshow(hasil);
